    ...
    <section className="p4 pb-16">
      ...
      <div className="flex flex-col w-full mt-6 gap-4 text-primary">
        <p>
          ...
          and we aim to collate those books in one place to make discovering and
          adoring them easier.
        </p>
        <p>
        ...
        <p>
          Whether it be our <TextLink href="/topics">curated lists</TextLink>{" "}
          separated into categories or topics, or engaging with our{" "}
          <TextLink href="/discover">AI recommendation tool</TextLink> that
          searches the world of non-fiction to find the perfect book for you or
          a loved one according to the provided interests and details - we hope
          to enhance the joy of learning about the world through books.
        </p>
        <p>
          So come with us on this journey, and discover the power of books to
