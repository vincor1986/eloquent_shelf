...
const SortButton = ({ sortFunction, sortMode, name }: ButtonProps) => {
...
type ContainerProps = {
  sortFunctions: {
    handleSortAZ: () => void;
    handleSortZA: () => void;
    handleSortRatingAsc: () => void;
    handleSortRatingDesc: () => void;
  };
  sortMode: string;
}

const SortContainer = ({ sortFunctions, sortMode }: ContainerProps) => {
  const {
    handleSortAZ,
    handleSortZA,
    handleSortRatingAsc,
