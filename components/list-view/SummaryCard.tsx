...
const SummaryCard = ({
  ...
  return (
    <div className="p-4 w-[250px] min-h-[550px] border-zinc-300 border rounded-md shadow-md flex flex-col justify-between hover:bg-zinc-100 hover:border-light-gold transition-colors duration-300">
      <div>
        ...
        <div className="mb-4">
          ...
          <p className="mt-2 text-secondary text-sm">{formatList(author)}</p>
        </div>
