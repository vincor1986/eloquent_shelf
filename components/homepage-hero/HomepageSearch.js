  ...
  return (
    <div className="mx-auto flex items-center justify-center max-w-9/10 gap-0.75">
      <div className="flex items-center justify-center my-8">
        <input
          className="relative border border-light-gold py-2 px-4 min-w-[350px] rounded-l-lg text-sm text-primary focus:outline-none focus:ring-2 focus:ring-light-gold focus:border-transparent"
          type="text"
